...
HELP_STRING = f"★ 𝐃𝐈𝐓𝐓𝐎 𝐁𝐎𝐓 𝐇𝐄𝐋𝐏 𝐌𝐄𝐍𝐔 ★\n\n» **ᴄʟɪᴄᴋ ᴏɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴꜱ ꜰᴏʀ ʜᴇʟᴘ**\n» **ᴅᴇᴠᴇʟᴏᴘᴇʀ: @Ditto_000**"
...
HELP_BUTTON = [
    ...
    [
      Button.url("• ᴄʜᴀɴɴᴇʟ •", "https://t.me/Ditto_stor"),
      Button.url("• sᴜᴘᴘᴏʀᴛ •", "https://t.me/DITTO_WORLD")
    ]
  ]
...
async def helpback(event):
    if event.query.user_id in SUDO_USERS:    
        ...
        await event.answer("Make Your Own Bots !! @Ditto_000", cache_time=0, alert=True)
...
async def help_raid(event):
    if event.query.user_id in SUDO_USERS:
        ...
        await event.answer("KHUDKE BANA LE BOT !! @Ditto_000", cache_time=0, alert=True)
